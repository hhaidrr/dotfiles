...
-- disabled this in favor of <C-l> for supermaven tab completion
...
ls.add_snippets("python", {
	...
	s("mlog", fmt(python_snips.logging_module, {})),
	s("class FrameTrace", fmt(python_snips.frametrace, {})),
	s("ll", fmt(python_snips.logging_local, {})),
	s(
		"ld",
		fmt("logger.debug({})", {
			i(1),
	...
	s("validate_type", fmt(python_snips.validate_type, {})),
	s(
		"ce",
		fmt('class {}(Exception):\n\t"""{}"""', {
			i(1),
	...
	-- dump service module
	s("dm", fmt(python_snips.dump_service, {})),
}, { key = "python" })
...
ls.add_snippets("markdown", {
	...
	s("standown", fmt(markdown_snips.standdown_document, {})),
}, { key = "markdown" })
